...
class _AppApiService implements AppApiService {
  ...
  @override
  Future<HttpResponse<List<String>>> getCategories() async {
  ...
  @override
  Future<HttpResponse<Joke>> getCategoryJoke(String category) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<Jokes>> searchJoke(String query) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'query': query};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<Jokes>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = Jokes.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
